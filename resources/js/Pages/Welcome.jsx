                            ...
                            <nav className="-mx-3 flex flex-1 justify-end">
                                {auth.user ? (
                                    <Link
                                        ...
                                        className="rounded-md px-3 py-2 text-black ring-1 ring-transparent transition  focus:outline-none  text-hover:text-white/80 focus-visible:ring-white"
                                    >
                                        Dashboard
                                    </Link>
                                ) : (
                                    <>
                                        <Link
                                            href={route("login")}
                                            className="rounded-md px-3 py-2 ring-1 ring-transparent transition  focus:outline-none text-white hover:text-white/80 focus-visible:ring-white"
                                        >
                                            Log in
                                        </Link>
                                        <Link
